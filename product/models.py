...
class Product(models.Model):
    type_product = models.CharField(max_length=50, unique=False, verbose_name='тип товара')
    date_delivery = models.DateField(unique=False, verbose_name='дата доставки')
    image = models.ImageField(unique=False, verbose_name='изображение товара')
